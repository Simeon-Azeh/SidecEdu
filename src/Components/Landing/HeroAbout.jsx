...
import HeroImg from '../../../public/Images/HeroAboutImg.png';
...
function HeroAbout() {
  const texts = ["Exist", "Started", "Build", "Innovate"];
    ...
    <div className='min-h-screen flex items-center justify-between md:w-4/5 m-auto font-poppins'>
      <div className='flex flex-col md:flex-row items-center p-2 md:p-0'>
        <div className='text-center mt-20 md:mt-0 md:text-left md:w-1/2' data-aos='fade-down'>
          ...
          <p className='text-lg mb-6 pop text-gray-500'>At Sidec, our singular focus is to elevate students' learning outcomes. Leveraging cutting-edge technology, we are dedicated to delivering high-quality content seamlessly. Our commitment extends beyond excellence; we prioritize convenience, ensuring accessibility for all, and ultimately, making a lasting impact on the educational journey of every student.</p>
          ...
          <button className='bg-[#9835ff] text-white px-6 py-3 rounded-lg font-normal text-lg transition-transform duration-300 hover:translate-y-[-3px] pop flex items-center gap-2  md:m-0'>
            Meet Team <IoMdArrowForward />
          </button>
          <button className='border border-[#9835ff] text-[#9835ff] px-6 py-3 rounded-lg font-normal text-lg transition-transform duration-300 hover:translate-y-[-3px] pop flex items-center gap-2  md:m-0'><IoPlayCircleOutline size={20} /> Learn More</button>
          </div>
