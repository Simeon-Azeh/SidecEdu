    ...
    <div className='bg-white font-poppins '>
      <div className='w-[100%] md:w-4/5 mx-auto flex flex-col md:flex-row items-center justify-between py-10 px-8 md:px-0 border-b'>
        <div className='flex flex-col gap-4'>
            ...
            <div className='flex gap-4 md:gap-8 text-[#404660] items-center  font-medium'>
                <Link to="/" className='hover:border-b-2 hover:border-[#9835ff] hover:border-solid'>Home</Link>
                <Link to="/about" className='hover:border-b-2 hover:border-[#9835ff] hover:border-solid'>About</Link>
                <Link to="/team" className='hover:border-b-2 hover:border-[#9835ff] hover:border-solid'>Team</Link>
                <Link to="/contact" className='hover:border-b-2 hover:border-[#9835ff] hover:border-solid'>Contact</Link>
            </div>
        </div>
        <div className='flex flex-col gap-4'>
      ...
      <div className='w-[100%] md:w-4/5 mx-auto flex flex-col md:flex-row items-center justify-between py-10 px-8 md:px-0'>
        ...
        <div className='flex gap-4 items-center font-poppins font-medium text-[#404660] text-[14px]'>
          <a href="/terms" className='hover:text-[#9835ff]'>Terms</a>
          <a href="/privacy" className='hover:text-[#9835ff]'>Privacy</a>
          <a href="/cookies" className='hover:text-[#9835ff]'>Cookies</a>
        </div>
      </div>
    </div>
  )
